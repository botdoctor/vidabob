...
interface VehicleCardRentalOnlyProps {
  vehicle: Vehicle;
  showRentButton?: boolean;
  onRent?: (vehicle: Vehicle) => void;
}

const VehicleCardRentalOnly: React.FC<VehicleCardRentalOnlyProps> = ({ vehicle, showRentButton = false, onRent }) => {
          ...
          <div className="flex justify-between items-center mb-4">
            <div>
              <div className="text-2xl font-bold text-blue-600">
                {formatPrice(vehicle.rentalPrice || 0)}/day
              </div>
              <div className="text-sm text-gray-600">Daily Rental Rate</div>
            </div>
          </div>

          <div className="flex space-x-2">
            <button 
              onClick={() => navigate(`/vehicle/${vehicle.id}/rental`)}
...
export default VehicleCardRentalOnly;