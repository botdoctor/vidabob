...
interface VehicleCardSaleOnlyProps {
  vehicle: Vehicle;
}

const VehicleCardSaleOnly: React.FC<VehicleCardSaleOnlyProps> = ({ vehicle }) => {
      ...
      <div className="p-6">
        ...
        <div className="border-t pt-4">
          ...
          <div className="flex space-x-2">
            <button 
              onClick={() => navigate(`/vehicle/${vehicle.id}/sale`)}
...
export default VehicleCardSaleOnly;