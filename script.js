...
document.addEventListener('DOMContentLoaded', function() {
    ...
    try {
        ...
        console.log('DOM elements found, rendering cars...');
        ...
        if (carsGrid) {
            carsGrid.innerHTML = '<div class="loading" style="color: red;">Error loading cars. Please refresh the page.</div>';
        }
    }
});
...
function renderCars() {
    ...
    if (filteredCars.length === 0) {
        carsGrid.innerHTML = '<div class="loading">No cars match your filters.</div>';
        return;
    }
...
function createCarCard(car) {
    ...
    div.innerHTML = `
        <img src="${car.image}" alt="${car.name}" class="car-image" onerror="this.src='https://via.placeholder.com/300x180/f0f0f0/666?text=Car+Image'">
